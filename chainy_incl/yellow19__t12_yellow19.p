...
fof(cc1_yellow19, axiom,  (! [A, B] :  ( ( ( ~ (v2_struct_0(A))  & l1_struct_0(A))  &  ( ~ (v2_struct_0(B))  &  (v3_orders_2(B) & l1_waybel_0(B, A)) ) )  =>  (! [C] :  (m1_yellow19(C, A, B) =>  ~ (v1_xboole_0(C)) ) ) ) ) ).
...
fof(t10_yellow19, axiom,  (! [A] :  ( ( ~ (v2_struct_0(A))  & l1_struct_0(A))  =>  (! [B] :  ( ( ~ (v2_struct_0(B))  &  (v4_orders_2(B) &  (v7_waybel_0(B) & l1_waybel_0(B, A)) ) )  =>  (! [C] :  ( ( ~ (v1_xboole_0(C))  & v1_finset_1(C))  =>  ~ ( ( (! [D] :  (m1_subset_1(D, C) => m1_yellow19(D, A, B)) )  &  (! [D] :  (m1_yellow19(D, A, B) =>  ~ (r1_tarski(D, k1_setfam_1(C))) ) ) ) ) ) ) ) ) ) ) ).
